...
{
    class PixelAlignedBitmap : UIElement
    {
        public PixelAlignedBitmap()
        {
        ...
        public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(
            "Source",
            typeof(BitmapSource),
            typeof(PixelAlignedBitmap),
            new FrameworkPropertyMetadata(
                null,
                FrameworkPropertyMetadataOptions.AffectsRender |
                FrameworkPropertyMetadataOptions.AffectsMeasure,
                new PropertyChangedCallback(PixelAlignedBitmap.OnSourceChanged)));
        ...
        protected override Size MeasureCore(Size availableSize)
        {
            ...
            if(bitmapSource != null)
            {
                ...
                if (ps != null)
                {
                    ...
                    measureSize = new Size(measureSizeV.X * _scale * _aspect, measureSizeV.Y * _scale);
                }
            }
        ...
        {
            PixelAlignedBitmap bitmap = (PixelAlignedBitmap)d;
            ...
            if (((newValue != null) && (newValue is BitmapSource)) && !newValue.IsFrozen)
            {
                ...
                // ((BitmapSource)newValue).DecodeFailed += bitmap._sourceFailed; // 3.5
                if (!((BitmapSource)newValue).IsDownloading)
                {
                    bitmap._sourceDownloaded(newValue, EventArgs.Empty);
                }
            }
        }
        ...
        private Point GetPixelOffset()
        {
            ...
            if (ps != null)
            {
                ...
                var transform = rootVisual.TransformToDescendant(this);
                if (transform != null)
                {
                    pixelOffset = transform.Transform(pixelOffset);
                }
            }
